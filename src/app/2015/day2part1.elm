        ...
        List.foldl
            (\line total ->
                let
                    ...
                    minimumFaceArea =
                        get 0 dimensions * get 1 dimensions

                    boxSize =
                        2 * get 0 dimensions * get 1 dimensions + 2 * get 0 dimensions * get 2 dimensions + 2 * get 1 dimensions * get 2 dimensions

                in
                    total + boxSize + minimumFaceArea
            ) 0 lines
